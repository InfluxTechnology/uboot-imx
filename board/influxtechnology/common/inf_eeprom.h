/*
 * Copyright (C) 2015 Influx Technology
 *
 * Configuration parameters stored in EEPROM for the Influx Technology 
 * i.MX 6 COM Board.
 *
 * SPDX-License-Identifier:	GPL-2.0+
 */

#ifndef __MX6SXINF_EEPROM_H
#define __MX6SXINF_EEPROM_H
