...
struct dram_fsp_msg inf_ddr_dram_fsp_msg[4] = {{1}};

#define INF_DBUF_SZ (16384)
#define INF_GZBUF_SZ (6144)
static unsigned char inf_dbuf[INF_DBUF_SZ] = {1};
static unsigned char inf_gzbuf[INF_GZBUF_SZ] = {1};
...
static void spl_ddr_map_array(enum inf_ddr_field idx, struct dram_cfg_param* a, int sz)
{
	...
	case INF_DDR_FSP0:
		/*
		 * First pair contains drate and fw_type
		 */
...
void board_init_f(ulong dummy)
{
	...
	/* Setup I2C for PMIC/eeprom and gpio expander */
